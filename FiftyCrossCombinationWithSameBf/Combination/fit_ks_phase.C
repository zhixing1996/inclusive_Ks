...
int main(int argc, char *argv[])
{
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString apple="/besfs/groups/tauqcd/jingmq/inclusive_Ks/FiftyCrossCombinationWithSameBf/rootfile/fit_ks_phase";
   for (int i=1; i<argc;i++){
    ...
    ofstream paras;
    TString orange="/besfs/groups/tauqcd/jingmq/inclusive_Ks/FiftyCrossCombinationWithSameBf/logfile/fit_ks_phase";
    for (int i=1; i<argc;i++){
      orange+="_";
      orange+=argv[i];
     }
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString banana="/besfs/groups/tauqcd/jingmq/inclusive_Ks/FiftyCrossCombinationWithSameBf/cross/fit_ks_phase";
    for (int i=1; i<argc;i++){
      banana+="_";
      banana+=argv[i];
    }
