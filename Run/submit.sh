...
usage() {
    ...
    printf "\n\t%-9s  %-40s"  "0.2.3.2"      "Generate fifty cross sections with divided branch fractions and random relative phases as well as combinations and fit" 
...
case $option in
    ...
    0.3.2.1) echo "Building necessary directories..."
             ...
             do 
                 ...
                 mkdir /besfs/groups/tauqcd/jingmq/inclusive_Ks/SameBf/TenCrossWithDiffNPhase/Combination$i/rootfile
                 mkdir /besfs/groups/tauqcd/jingmq/inclusive_Ks/SameBf/TenCrossWithDiffNPhase/Combination$i/logfile
                 mkdir /besfs/groups/tauqcd/jingmq/inclusive_Ks/SameBf/TenCrossWithDiffNPhase/Combination$i/cross
             done
             ;;
