...
int main(int argc, char *argv[])
{
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString apple="/besfs/groups/tauqcd/jingmq/inclusive_Ks/EquidifferentBf/TenCrossWithDiffNPhase/rootfile/fit_ks_phase";
    ...
    ofstream paras;
    TString orange="/besfs/groups/tauqcd/jingmq/inclusive_Ks/EquidifferentBf/TenCrossWithDiffNPhase/logfile/fit_ks_phase";
    for (int i=1; i<argc;i++){
      orange+="_";
      orange+=argv[i];
     }
    ...
    stream1 << argv[1];
    TString greap1="../0.01/"+stream1.str()+"/fit_ks_phase.txt";
    ...
    stream2 << argv[2];
    TString greap2="../0.015/"+stream2.str()+"/fit_ks_phase.txt";
    ...
    stream3 << argv[3];
    TString greap3="../0.02/"+stream3.str()+"/fit_ks_phase.txt";
    ...
    stream4 << argv[4];
    TString greap4="../0.025/"+stream4.str()+"/fit_ks_phase.txt";
    ...
    stream5 << argv[5];
    TString greap5="../0.03/"+stream5.str()+"/fit_ks_phase.txt";
    ...
    stream6 << argv[6];
    TString greap6="../0.035/"+stream6.str()+"/fit_ks_phase.txt";
    ...
    stream7 << argv[7];
    TString greap7="../0.04/"+stream7.str()+"/fit_ks_phase.txt";
    ...
    stream8 << argv[8];
    TString greap8="../0.045/"+stream8.str()+"/fit_ks_phase.txt";
    ...
    stream9 << argv[9];
    TString greap9="../0.05/"+stream9.str()+"/fit_ks_phase.txt";
    ...
    stream10 << argv[10];
    TString greap10="../0.055/"+stream10.str()+"/fit_ks_phase.txt";
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString banana="/besfs/groups/tauqcd/jingmq/inclusive_Ks/EquidifferentBf/TenCrossWithDiffNPhase/cross/fit_ks_phase";
    for (int i=1; i<argc;i++){
      banana+="_";
      banana+=argv[i];
     }
