...
int main(int argc, char *argv[])
{
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString apple="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TwoCrossWithDiffPhase/Combination_0_90/rootfile/fit_ks_phase_combination";
    ...
    ofstream paras;
    TString orange="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TwoCrossWithDiffPhase/Combination_0_90/logfile/fit_ks_phase_combination";
    for (int i=1; i<argc;i++){
      orange+="_";
      orange+=argv[i];
     }
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString banana="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TwoCrossWithDiffPhase/Combination_0_90/cross/fit_ks_phase_combination";
    for (int i=1; i<argc;i++){
      banana+="_";
      banana+=argv[i];
     }
