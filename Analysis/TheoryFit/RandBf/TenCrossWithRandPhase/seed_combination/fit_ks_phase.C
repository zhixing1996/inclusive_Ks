...
int main(int argc, char *argv[])
{
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString apple="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TenCrossWithRandPhase/rootfile/fit_ks_phase_combination";
    for (int i=1; i<argc;i++){
      apple+="_";
      apple+=argv[i];
     }
    ...
    ofstream paras;
    TString orange="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TenCrossWithRandPhase/logfile/fit_ks_phase_combination";
    for (int i=1; i<argc;i++){
      orange+="_";
      orange+=argv[i];
     }
   ...
   for (int i=0;i<Npoints;i++ ){
    ...
    TString banana="/besfs/groups/tauqcd/jingmq/inclusive_Ks/RandBf/TenCrossWithRandPhase/cross/fit_ks_phase_combination";
    for (int i=1; i<argc;i++){
      banana+="_";
      banana+=argv[i];
     }
