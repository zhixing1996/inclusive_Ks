...
void DrawFit8(){
    ...
    // ifstream openfile;
    // openfile.open("../GetPhase/Phase8.txt");
    ...
    RooRealVar Phase("Phase","",-90,-20);
    RooArgSet mchic_etapipi;
    mchic_etapipi.add(RooArgSet(Phase));
    RooDataSet *Distribution= RooDataSet::read("../GetPhase/Phase8.txt",mchic_etapipi,"Q");
    RooRealVar mean("mean", "mean", -45, -90,-20);
