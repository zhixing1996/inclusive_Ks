...
void DrawFit2(){
    ...
    RooRealVar Phase("Phase","",-2.0,-1.8);
    RooArgSet mchic_etapipi;
    mchic_etapipi.add(RooArgSet(Phase));
    RooDataSet *Distribution= RooDataSet::read("../GetPhase/Phase2.txt",mchic_etapipi,"Q");
    RooRealVar mean("mean", "mean", -1.9, -2,-1.8);
