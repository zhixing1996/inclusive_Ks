void DrawFit_0_90()
{
	...
	pad->Draw();
        ...
        RooRealVar Phase("Phase","",12,80);

	RooArgSet mchic_etapipi;
	mchic_etapipi.add(RooArgSet(Phase));
	RooDataSet *Distribution= RooDataSet::read("../GetPhase/Phase_0_90.txt",mchic_etapipi,"Q");
	//cout<<__LINE__<<endl;
        RooRealVar mean("mean", "mean", 45, 12,80);
