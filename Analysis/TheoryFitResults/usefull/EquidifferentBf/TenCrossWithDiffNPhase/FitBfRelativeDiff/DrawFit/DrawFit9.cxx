...
void DrawFit9(){
    ...
    // ifstream openfile;
    // openfile.open("../CalRelativeDiff/RelativeDiff9.txt");
    ...
    RooDataSet *Distribution= RooDataSet::read("../CalRelativeDiff/RelativeDiff9.txt",mchic_etapipi,"Q");
