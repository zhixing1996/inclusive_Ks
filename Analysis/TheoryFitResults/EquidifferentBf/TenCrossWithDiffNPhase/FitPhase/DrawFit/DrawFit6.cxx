...
void DrawFit6(){
    ...
    RooRealVar Phase("Phase","",-1,-0.9);
    RooArgSet mchic_etapipi;
    mchic_etapipi.add(RooArgSet(Phase));
    RooDataSet *Distribution= RooDataSet::read("../GetPhase/Phase6.txt",mchic_etapipi,"Q");
    RooRealVar mean("mean", "mean", -0.95, -1,-0.9);
