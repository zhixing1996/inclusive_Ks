...
void DrawFit3(){
    ...
    RooRealVar BfDiff("RelativeDiff","",15,30);
    RooArgSet mchic_etapipi;
    mchic_etapipi.add(RooArgSet(BfDiff));
    RooDataSet *Distribution= RooDataSet::read("../CalRelativeDiff/RelativeDiff3.txt",mchic_etapipi,"Q");
    RooRealVar mean("mean", "mean", 23, 15,30);
